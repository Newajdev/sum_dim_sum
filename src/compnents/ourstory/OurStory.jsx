    ...
    return (
        <Container>
            <section className='py-[40px] lg:py-[120px]'>
                {/* Story Section */}
                <div className='lg:relative w-full lg:mb-[75px] '>
                    <div style={{
                    ...
                    <div className='lg:absolute top-[60px] right-128'>
                        <div className='relative'>
                            <div className='hidden lg:flex w-[512px] h-[365px] rounded-[20px] absolute top-6 -left-6 z-10 '>
                                <Image src={'/assets/ourStory.png'} height={365} width={512} alt='our Story'/>
                            </div>
                            <div className='hidden lg:flex w-[512px] h-[365px] border border-[#B31217] rounded-[20px] absolute '></div>
                        </div>
                    </div>
                </div>

                {/* Statistics */}
                <div className='pt-[60px] grid grid-cols-2 gap-y-2 lg:grid-cols-4 lg:gap-0'>
                    {/* happy guest */}
