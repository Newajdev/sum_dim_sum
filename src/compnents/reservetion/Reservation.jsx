...
const Reservation = () => {
    return (
        <div>
            <Container>
                <div className='grid grid-cols-2 py-[120px]'>
                    <div >
